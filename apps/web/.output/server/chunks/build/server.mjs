import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, hasInjectionContext, getCurrentInstance, toRef, isRef, ref, customRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, inject, unref, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, toValue, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { p as parseURL, k as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, h as joinURL, w as withQuery, o as klona, s as sanitizeStatusCode, q as parse, r as getRequestHeader, t as isEqual, v as getContext, x as setCookie, y as getCookie, z as deleteCookie, $ as $fetch$1, A as defu, c as createError$1, B as executeAsync, C as hash } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./login-CSUa51U6.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "auth" } },
    component: () => import('./index-Dsx3ds7J.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DLk3xMT_.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-DfEehGI6.mjs'),
  guest: () => import('./guest-De2K-B6f.mjs')
};
...
const useApi = () => {
  ...
  const request = async (path, options = {}) => {
    ...
    try {
      return await $fetch(`${apiBase}${cleanPath}`, {
        ...options,
        headers
      });
    } catch (error) {
...
const useAuth = () => {
  ...
  const token = useCookie("auth_token", {
    maxAge: 60 * 60 * 8,
    // 8 horas (duração igual à do backend JWT_EXPIRATION)
    sameSite: "lax",
...
const auth_init_vEJObuXT7b1llgPBZ9twzrqxjzXrhzHSvtzvxn6UZ34 = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
...
const plugins = [
  ...
  auth_init_vEJObuXT7b1llgPBZ9twzrqxjzXrhzHSvtzvxn6UZ34
];
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-BcFKJZ8p.mjs').then((m) => m.default || m)),
  auth: defineAsyncComponent(() => import('./auth-CMQDRH67.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-DMhoE1Bj.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DiMcLXmr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DLeGuvZy.mjs'));
...
export { _export_sfc as _, useApi as a, useNuxtApp as b, useRouter as c, defineNuxtRouteMiddleware as d, entry_default as default, encodeRoutePath as e, useRuntimeConfig as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, useAuth as u };
