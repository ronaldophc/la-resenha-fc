<template>
  <footer class="app-footer">
    <div class="footer-brand">{{ settings.clubName }}</div>

    <!-- Redes sociais (ícones aparecem só quando configurados) -->
    <div v-if="socialLinks.length > 0" class="footer-social">
      ...
      >
        <svg class="footer-social-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <div class="footer-copyright">
      © {{ currentYear }} {{ settings.clubName }}
    </div>
  </footer>

  <!-- Sub-footer: créditos do desenvolvedor -->
  <div class="dev-footer">
    <span class="dev-footer-text">
      Desenvolvido por
      <a href="https://github.com/ronaldophc" target="_blank" rel="noopener" class="dev-footer-link">
        Ronaldo P H Campos
      </a>
    </span>
    <div class="dev-footer-links">
      <a href="https://github.com/ronaldophc" target="_blank" rel="noopener" class="dev-footer-link">GitHub</a>
      <a href="https://www.linkedin.com/in/ronaldophc" target="_blank" rel="noopener" class="dev-footer-link">LinkedIn</a>
    </div>
  </div>
</template>
...
// Paths SVG das marcas (Simple Icons, viewBox 0 0 24 24)
...
.dev-footer {
  ...
  justify-content: center;
  gap: 8px 24px;
  padding: 14px var(--space-margin-mobile);
...
@media (min-width: 768px) {
  .dev-footer {
    padding: 14px var(--space-margin-desktop);
  }
}
